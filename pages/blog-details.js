              ...
              <div className="col-lg-8">
                ...
                <div className="avatar-post">
                  ...
                  <div className="post-avatar-content">
                    <p>
                      Eam soluta dicunt cu. Est ad oporteat appellantur, per
                      dicta pertinax cu. Iusto quando conceptam vim ad, an sed
                      explicari appellantur. Accumsan pericula usu an, in pri
                      dolorum denique. Cu movet debitis cum
                    </p>
                    <span>
                      Nicole Willis <br /> Writer
                    </span>
                  </div>
                </div>
                      ...
                      <ul className="list-wrap">
                        <li>
                          <div className="comments-box">
                            <div className="comments-avatar">
                              <img
                                src="/assets/img/blog/comment_img01.png"
                                alt=""
                              />
                            </div>
                        ...
                        <li>
                          <div className="comments-box">
                            <div className="comments-avatar">
                              <img
                                src="/assets/img/blog/comment_img02.png"
                                alt=""
                              />
                            </div>
                            <div className="comment-text">
                  ...
                  <div className="blog-widget">
                    ...
                    <div className="post-list-wrap">
                      ...
                      <div className="post-item">
                        <h4 className="title">
                          <Link href="blog-details">
                            space solutions and small apartment ideas
                          </Link>
                        </h4>
